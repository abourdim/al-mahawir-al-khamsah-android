# Play Store listing — Al Mahawir al-Khamsah (المحاور الخمسة للقرآن الكريم)
...
- **Package name**: `org.workshopdiy.almahawiralkhamsah`
...
```
كتاب "المحاور الخمسة للقرآن الكريم" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
🔥 المحاور الخمسة للقرآن الكريم — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "المحاور الخمسة للقرآن الكريم" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "المحاور الخمسة للقرآن الكريم" — الشيخ محمد الغزالي
...
### App name
```
Al Mahawir al-Khamsah — The Five Axes of the Quran
```

### Short description
```
"The Five Axes of the Quran" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "The Five Axes of the Quran" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "The Five Axes of the Quran" — Sheikh Mohammed al-Ghazali
...
### App name
```
Al Mahawir al-Khamsah — Al Mahawir al-Khamsah
```

### Short description
```
« The Five Axes of the Quran » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « The Five Axes of the Quran » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « The Five Axes of the Quran » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Al Mahawir al-Khamsah
Last updated: 2026-04-26

The Al Mahawir al-Khamsah app does not collect, store, transmit, or share any personal
